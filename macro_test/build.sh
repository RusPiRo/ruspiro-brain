...
if [ $1 = "64" ]
    ...
    then
        ...
        RUSTFLAGS="-C linker=${PREFIX}gcc -C target-cpu=cortex-a53 -C target-feature=+strict-align,+a53,+fp-armv8,+v8,+vfp3,+d16,+thumb2,+neon -C link-arg=-nostartfiles -C opt-level=3 -C debuginfo=0 -C link-arg=-T./link32.ld"
...
cargo +nightly xbuild --target ${TARGET} --release #--features ruspiro_pi3
